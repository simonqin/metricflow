          ...
          FROM (
            ...
            FROM (
              ...
              SELECT /*+ SET_VAR(cte_inline=true) */
                ...
                , YEAR(bookings_source_src_26000.ds) AS ds__extract_year
                , QUARTER(bookings_source_src_26000.ds) AS ds__extract_quarter
                , MONTH(bookings_source_src_26000.ds) AS ds__extract_month
                , DAY(bookings_source_src_26000.ds) AS ds__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.ds) AS ds__extract_dow
                ...
                , YEAR(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_year
                , QUARTER(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_quarter
                , MONTH(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_month
                , DAY(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_dow
                ...
                , YEAR(bookings_source_src_26000.paid_at) AS paid_at__extract_year
                , QUARTER(bookings_source_src_26000.paid_at) AS paid_at__extract_quarter
                , MONTH(bookings_source_src_26000.paid_at) AS paid_at__extract_month
                , DAY(bookings_source_src_26000.paid_at) AS paid_at__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.paid_at) AS paid_at__extract_dow
                ...
                , YEAR(bookings_source_src_26000.ds) AS booking__ds__extract_year
                , QUARTER(bookings_source_src_26000.ds) AS booking__ds__extract_quarter
                , MONTH(bookings_source_src_26000.ds) AS booking__ds__extract_month
                , DAY(bookings_source_src_26000.ds) AS booking__ds__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.ds) AS booking__ds__extract_dow
                ...
                , YEAR(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_year
                , QUARTER(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_quarter
                , MONTH(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_month
                , DAY(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_dow
                ...
                , YEAR(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_year
                , QUARTER(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_quarter
                , MONTH(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_month
                , DAY(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_dow
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT /*+ SET_VAR(cte_inline=true) */
                  ...
                  , YEAR(listings_src_26000.active_from) AS window_start__extract_year
                  , QUARTER(listings_src_26000.active_from) AS window_start__extract_quarter
                  , MONTH(listings_src_26000.active_from) AS window_start__extract_month
                  , DAY(listings_src_26000.active_from) AS window_start__extract_day
                  , DAY_OF_WEEK_ISO(listings_src_26000.active_from) AS window_start__extract_dow
                  ...
                  , YEAR(listings_src_26000.active_to) AS window_end__extract_year
                  , QUARTER(listings_src_26000.active_to) AS window_end__extract_quarter
                  , MONTH(listings_src_26000.active_to) AS window_end__extract_month
                  , DAY(listings_src_26000.active_to) AS window_end__extract_day
                  , DAY_OF_WEEK_ISO(listings_src_26000.active_to) AS window_end__extract_dow
                  ...
                  , YEAR(listings_src_26000.active_from) AS listing__window_start__extract_year
                  , QUARTER(listings_src_26000.active_from) AS listing__window_start__extract_quarter
                  , MONTH(listings_src_26000.active_from) AS listing__window_start__extract_month
                  , DAY(listings_src_26000.active_from) AS listing__window_start__extract_day
                  , DAY_OF_WEEK_ISO(listings_src_26000.active_from) AS listing__window_start__extract_dow
                  ...
                  , YEAR(listings_src_26000.active_to) AS listing__window_end__extract_year
                  , QUARTER(listings_src_26000.active_to) AS listing__window_end__extract_quarter
                  , MONTH(listings_src_26000.active_to) AS listing__window_end__extract_month
                  , DAY(listings_src_26000.active_to) AS listing__window_end__extract_day
                  , DAY_OF_WEEK_ISO(listings_src_26000.active_to) AS listing__window_end__extract_dow
              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT /*+ SET_VAR(cte_inline=true) */
                    ...
                    , YEAR(users_latest_src_26000.ds) AS ds__extract_year
                    , QUARTER(users_latest_src_26000.ds) AS ds__extract_quarter
                    , MONTH(users_latest_src_26000.ds) AS ds__extract_month
                    , DAY(users_latest_src_26000.ds) AS ds__extract_day
                    , DAY_OF_WEEK_ISO(users_latest_src_26000.ds) AS ds__extract_dow
                    ...
                    , YEAR(users_latest_src_26000.ds) AS user__ds__extract_year
                    , QUARTER(users_latest_src_26000.ds) AS user__ds__extract_quarter
                    , MONTH(users_latest_src_26000.ds) AS user__ds__extract_month
                    , DAY(users_latest_src_26000.ds) AS user__ds__extract_day
                    , DAY_OF_WEEK_ISO(users_latest_src_26000.ds) AS user__ds__extract_dow
