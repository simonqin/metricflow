          ...
          FROM (
            ...
            FROM (
              ...
              SELECT /*+ SET_VAR(cte_inline=true) */
                ...
                , YEAR(accounts_source_src_28000.ds) AS ds__extract_year
                , QUARTER(accounts_source_src_28000.ds) AS ds__extract_quarter
                , MONTH(accounts_source_src_28000.ds) AS ds__extract_month
                , DAY(accounts_source_src_28000.ds) AS ds__extract_day
                , DAY_OF_WEEK_ISO(accounts_source_src_28000.ds) AS ds__extract_dow
                ...
                , YEAR(accounts_source_src_28000.ds_month) AS ds_month__extract_year
                , QUARTER(accounts_source_src_28000.ds_month) AS ds_month__extract_quarter
                , MONTH(accounts_source_src_28000.ds_month) AS ds_month__extract_month
                ...
                , YEAR(accounts_source_src_28000.ds) AS account__ds__extract_year
                , QUARTER(accounts_source_src_28000.ds) AS account__ds__extract_quarter
                , MONTH(accounts_source_src_28000.ds) AS account__ds__extract_month
                , DAY(accounts_source_src_28000.ds) AS account__ds__extract_day
                , DAY_OF_WEEK_ISO(accounts_source_src_28000.ds) AS account__ds__extract_dow
                ...
                , YEAR(accounts_source_src_28000.ds_month) AS account__ds_month__extract_year
                , QUARTER(accounts_source_src_28000.ds_month) AS account__ds_month__extract_quarter
                , MONTH(accounts_source_src_28000.ds_month) AS account__ds_month__extract_month
