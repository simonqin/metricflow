              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT /*+ SET_VAR(cte_inline=true) */
                    ...
                    , YEAR(lux_listings_src_26000.valid_from) AS window_start__extract_year
                    , QUARTER(lux_listings_src_26000.valid_from) AS window_start__extract_quarter
                    , MONTH(lux_listings_src_26000.valid_from) AS window_start__extract_month
                    , DAY(lux_listings_src_26000.valid_from) AS window_start__extract_day
                    , DAY_OF_WEEK_ISO(lux_listings_src_26000.valid_from) AS window_start__extract_dow
                    ...
                    , YEAR(lux_listings_src_26000.valid_to) AS window_end__extract_year
                    , QUARTER(lux_listings_src_26000.valid_to) AS window_end__extract_quarter
                    , MONTH(lux_listings_src_26000.valid_to) AS window_end__extract_month
                    , DAY(lux_listings_src_26000.valid_to) AS window_end__extract_day
                    , DAY_OF_WEEK_ISO(lux_listings_src_26000.valid_to) AS window_end__extract_dow
                    ...
                    , YEAR(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_year
                    , QUARTER(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_quarter
                    , MONTH(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_month
                    , DAY(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_day
                    , DAY_OF_WEEK_ISO(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_dow
                    ...
                    , YEAR(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_year
                    , QUARTER(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_quarter
                    , MONTH(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_month
                    , DAY(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_day
                    , DAY_OF_WEEK_ISO(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_dow
