          ...
          FROM (
            ...
            FROM (
              ...
              SELECT /*+ SET_VAR(cte_inline=true) */
                ...
                , YEAR(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_year
                , QUARTER(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_quarter
                , MONTH(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_month
                , DAY(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_dow
                ...
                , YEAR(account_month_txns_src_22000.ds) AS ds__extract_year
                , QUARTER(account_month_txns_src_22000.ds) AS ds__extract_quarter
                , MONTH(account_month_txns_src_22000.ds) AS ds__extract_month
                , DAY(account_month_txns_src_22000.ds) AS ds__extract_day
                , DAY_OF_WEEK_ISO(account_month_txns_src_22000.ds) AS ds__extract_dow
                ...
                , YEAR(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_year
                , QUARTER(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_quarter
                , MONTH(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_month
                , DAY(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_dow
                ...
                , YEAR(account_month_txns_src_22000.ds) AS account_id__ds__extract_year
                , QUARTER(account_month_txns_src_22000.ds) AS account_id__ds__extract_quarter
                , MONTH(account_month_txns_src_22000.ds) AS account_id__ds__extract_month
                , DAY(account_month_txns_src_22000.ds) AS account_id__ds__extract_day
                , DAY_OF_WEEK_ISO(account_month_txns_src_22000.ds) AS account_id__ds__extract_dow
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT /*+ SET_VAR(cte_inline=true) */
                    ...
                    , YEAR(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_year
                    , QUARTER(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_quarter
                    , MONTH(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_month
                    , DAY(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_day
                    , DAY_OF_WEEK_ISO(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_dow
                    ...
                    , YEAR(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_year
                    , QUARTER(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_quarter
                    , MONTH(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_month
                    , DAY(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_day
                    , DAY_OF_WEEK_ISO(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_dow
                    ...
                    , YEAR(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_year
                    , QUARTER(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_quarter
                    , MONTH(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_month
                    , DAY(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_day
                    , DAY_OF_WEEK_ISO(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_dow
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT /*+ SET_VAR(cte_inline=true) */
                      ...
                      , YEAR(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_year
                      , QUARTER(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_quarter
                      , MONTH(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_month
                      , DAY(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_day
                      , DAY_OF_WEEK_ISO(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_dow
                      ...
                      , YEAR(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_year
                      , QUARTER(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_quarter
                      , MONTH(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_month
                      , DAY(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_day
                      , DAY_OF_WEEK_ISO(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_dow
