        ...
        FULL OUTER JOIN (
          ...
          FROM (
            ...
            SELECT /*+ SET_VAR(cte_inline=true) */
              ...
              , YEAR(users_latest_src_28000.ds) AS ds_latest__extract_year
              , QUARTER(users_latest_src_28000.ds) AS ds_latest__extract_quarter
              , MONTH(users_latest_src_28000.ds) AS ds_latest__extract_month
              , DAY(users_latest_src_28000.ds) AS ds_latest__extract_day
              , DAY_OF_WEEK_ISO(users_latest_src_28000.ds) AS ds_latest__extract_dow
              ...
              , YEAR(users_latest_src_28000.ds) AS user__ds_latest__extract_year
              , QUARTER(users_latest_src_28000.ds) AS user__ds_latest__extract_quarter
              , MONTH(users_latest_src_28000.ds) AS user__ds_latest__extract_month
              , DAY(users_latest_src_28000.ds) AS user__ds_latest__extract_day
              , DAY_OF_WEEK_ISO(users_latest_src_28000.ds) AS user__ds_latest__extract_dow
