          ...
          FROM (
            ...
            FROM (
              ...
              SELECT /*+ SET_VAR(cte_inline=true) */
                ...
                , YEAR(id_verifications_src_28000.ds) AS ds__extract_year
                , QUARTER(id_verifications_src_28000.ds) AS ds__extract_quarter
                , MONTH(id_verifications_src_28000.ds) AS ds__extract_month
                , DAY(id_verifications_src_28000.ds) AS ds__extract_day
                , DAY_OF_WEEK_ISO(id_verifications_src_28000.ds) AS ds__extract_dow
                , DAYOFYEAR(id_verifications_src_28000.ds) AS ds__extract_doy
                ...
                , YEAR(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_year
                , QUARTER(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_quarter
                , MONTH(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_month
                , DAY(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_dow
                , DAYOFYEAR(id_verifications_src_28000.ds_partitioned) AS ds_partitioned__extract_doy
                ...
                , YEAR(id_verifications_src_28000.ds) AS verification__ds__extract_year
                , QUARTER(id_verifications_src_28000.ds) AS verification__ds__extract_quarter
                , MONTH(id_verifications_src_28000.ds) AS verification__ds__extract_month
                , DAY(id_verifications_src_28000.ds) AS verification__ds__extract_day
                , DAY_OF_WEEK_ISO(id_verifications_src_28000.ds) AS verification__ds__extract_dow
                , DAYOFYEAR(id_verifications_src_28000.ds) AS verification__ds__extract_doy
                ...
                , YEAR(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_year
                , QUARTER(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_quarter
                , MONTH(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_month
                , DAY(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_dow
                , DAYOFYEAR(id_verifications_src_28000.ds_partitioned) AS verification__ds_partitioned__extract_doy
