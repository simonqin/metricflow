          ...
          FROM (
            ...
            FROM (
              ...
              SELECT /*+ SET_VAR(cte_inline=true) */
                ...
                , YEAR(bookings_source_src_28000.ds) AS ds__extract_year
                , QUARTER(bookings_source_src_28000.ds) AS ds__extract_quarter
                , MONTH(bookings_source_src_28000.ds) AS ds__extract_month
                , DAY(bookings_source_src_28000.ds) AS ds__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.ds) AS ds__extract_dow
                ...
                , YEAR(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_year
                , QUARTER(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_quarter
                , MONTH(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_month
                , DAY(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_dow
                ...
                , YEAR(bookings_source_src_28000.paid_at) AS paid_at__extract_year
                , QUARTER(bookings_source_src_28000.paid_at) AS paid_at__extract_quarter
                , MONTH(bookings_source_src_28000.paid_at) AS paid_at__extract_month
                , DAY(bookings_source_src_28000.paid_at) AS paid_at__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.paid_at) AS paid_at__extract_dow
                ...
                , YEAR(bookings_source_src_28000.ds) AS booking__ds__extract_year
                , QUARTER(bookings_source_src_28000.ds) AS booking__ds__extract_quarter
                , MONTH(bookings_source_src_28000.ds) AS booking__ds__extract_month
                , DAY(bookings_source_src_28000.ds) AS booking__ds__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.ds) AS booking__ds__extract_dow
                ...
                , YEAR(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_year
                , QUARTER(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_quarter
                , MONTH(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_month
                , DAY(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_dow
                ...
                , YEAR(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_year
                , QUARTER(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_quarter
                , MONTH(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_month
                , DAY(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_day
                , DAY_OF_WEEK_ISO(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_dow
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT /*+ SET_VAR(cte_inline=true) */
                      ...
                      , YEAR(users_ds_source_src_28000.ds) AS ds__extract_year
                      , QUARTER(users_ds_source_src_28000.ds) AS ds__extract_quarter
                      , MONTH(users_ds_source_src_28000.ds) AS ds__extract_month
                      , DAY(users_ds_source_src_28000.ds) AS ds__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.ds) AS ds__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.ds) AS ds__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.created_at) AS created_at__extract_year
                      , QUARTER(users_ds_source_src_28000.created_at) AS created_at__extract_quarter
                      , MONTH(users_ds_source_src_28000.created_at) AS created_at__extract_month
                      , DAY(users_ds_source_src_28000.created_at) AS created_at__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.created_at) AS created_at__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.created_at) AS created_at__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_year
                      , QUARTER(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_quarter
                      , MONTH(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_month
                      , DAY(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.ds_partitioned) AS ds_partitioned__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_month
                      , DAY(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_month
                      , DAY(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.bio_added_ts) AS bio_added_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_month
                      , DAY(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.last_login_ts) AS last_login_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.archived_at) AS archived_at__extract_year
                      , QUARTER(users_ds_source_src_28000.archived_at) AS archived_at__extract_quarter
                      , MONTH(users_ds_source_src_28000.archived_at) AS archived_at__extract_month
                      , DAY(users_ds_source_src_28000.archived_at) AS archived_at__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.archived_at) AS archived_at__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.archived_at) AS archived_at__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.ds) AS user__ds__extract_year
                      , QUARTER(users_ds_source_src_28000.ds) AS user__ds__extract_quarter
                      , MONTH(users_ds_source_src_28000.ds) AS user__ds__extract_month
                      , DAY(users_ds_source_src_28000.ds) AS user__ds__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.ds) AS user__ds__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.ds) AS user__ds__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.created_at) AS user__created_at__extract_year
                      , QUARTER(users_ds_source_src_28000.created_at) AS user__created_at__extract_quarter
                      , MONTH(users_ds_source_src_28000.created_at) AS user__created_at__extract_month
                      , DAY(users_ds_source_src_28000.created_at) AS user__created_at__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.created_at) AS user__created_at__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.created_at) AS user__created_at__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_year
                      , QUARTER(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_quarter
                      , MONTH(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_month
                      , DAY(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.ds_partitioned) AS user__ds_partitioned__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_month
                      , DAY(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_month
                      , DAY(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.bio_added_ts) AS user__bio_added_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_year
                      , QUARTER(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_quarter
                      , MONTH(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_month
                      , DAY(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.last_login_ts) AS user__last_login_ts__extract_doy
                      ...
                      , YEAR(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_year
                      , QUARTER(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_quarter
                      , MONTH(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_month
                      , DAY(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_day
                      , DAY_OF_WEEK_ISO(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_dow
                      , DAYOFYEAR(users_ds_source_src_28000.archived_at) AS user__archived_at__extract_doy
